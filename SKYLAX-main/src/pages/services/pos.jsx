          ...
          <div className="relative z-10 header_con pt-20 pb-16">
            ...
            <div className="hidden">
              ...
              <span className="text-sm max-w-xs text-[#B5C7D1] text-right">
                All-in-one tools to streamline sales and improve daily performance.
              </span>
            </div>

            {/* Big stacked heading - CENTERED; glass uses custom gradient */}
            <div className="mt-6 text-center -mb-4 sm:-mb-8 lg:-mb-12 relative z-20 translate-y-5 sm:translate-y-6 lg:translate-y-7">
              <div className="inline-block mx-auto rounded-2xl bg-[linear-gradient(74.03deg,#1B2128_44.84%,#3B6078_84.85%)] backdrop-blur-md px-2 sm:px-3 lg:px-4 py-1 sm:py-1.5 lg:py-2 shadow-[0_10px_40px_rgba(0,0,0,0.35)]">
                <h2 className="font_neue_montreal_regular leading-[0.95] uppercase">
                  <span className="block text-[40px] sm:text-[64px] lg:text-[84px] tracking-tight text-white/90">POS</span>
                  <span className="block text-[48px] sm:text-[72px] lg:text-[96px] tracking-tight text-white/60">SYSTEMS</span>
                </h2>
              </div>
            </div>
            ...
            <div className="mt-6 md:hidden">
              <p className="text-sm text-[#B5C7D1] text-center">All‑in‑one tools to streamline sales and improve daily performance.</p>
            </div>
          </div>
        </section>
      </ServicesGradientWrapper>
